...
public class CppDockerCompileAndRun implements DockerCompileAndRun {
    private static final String IMAGE_NAME = "gcc:6.5.0";
    ...
    public void compile(String code) {
        ...
        // 预构建 执行编译命令
        // docker exec d8199caa4c0b g++ /data/main.cpp
        String[] cmd = new String[]{"g++", "/data/main.cpp", "-o", "/data/main", "-O2"};
    ...
    public ExecuteResult run(List<String> judgeCases) {
        ...
        try {
            ...
            Process exec = Runtime.getRuntime().exec(String.format("docker run --rm --memory=100m -i -v %s:/data %s ./data/main", filepath, IMAGE_NAME));
